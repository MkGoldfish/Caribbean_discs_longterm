...
library(tidyverse)
library(microbiome)
update.packages("devtools", "BiocManager")
...
physeq_object <- merge_phyloseq(sub1, sub2) # 2,378,997 reads



####basic_info#####
summarize_phyloseq(physeq_object)# Total number of reads = 3,107,191
ntaxa(physeq_object)
